...
<html>
  ...
  <link rel="stylesheet" type="text/css" href="jqueryEasyUI/easyui.css">
	...
	<link rel="stylesheet" type="text/css" href="css/selfCSS/navigator.css"/>			<!-- 用于设置页面导航的样式 -->
...
<div class="easyui-layout" style="width:100%;height:1000px;">
	<%@include file="../../commonHead.jsp" %>
 	...
 	<div data-options="region:'center'" style="background:url(${pageContext.request.contextPath}/images/bg.jpg) no-repeat;background-size:100%;">
 		<div class="easyui-layout" data-options="fit:true">
 			...
 			<!-- 
 			<div data-options="region:'west'"  style="height: 100%; width: 50%; float: left;">
	           <div class="easyui-layout" data-options="fit:true">
	              <div data-options="region:'north'" style="height: 30px;margin-top: 1px;">
	              	<input id="iconTaskType" name="dept" value="请选择任务类型" style="width:100%;height: 26px;">
	              </div>
	              <div data-options="region:'center'" id="canvasLeft"></div>
	           </div>
           </div>
           <div data-options="region:'center'" style="height: 100%; width: 49%; float: left; margin-left: -1px;">
	           <div class="easyui-layout" data-options="fit:true">
		              <div data-options="region:'north'" style="height: 30px;margin-top: 1px;">
		              	任务名称: <input id="iconTaskName" type="text" name="taskName" style="width:80%;" class="easyui-textbox"/>
		              	<a href="javascript:void(0)" onclick="editIconTask();" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改</a> 
		              	<a href="javascript:void(0)" onclick="saveIconTask();" class="easyui-linkbutton" data-options="iconCls:'icon-save'">保存</a>
		              </div>
		              <div id="iconEditTaskDiv"></div>
		              <div data-options="region:'center'" id="canvasRight"></div>
		           </div>
           </div>
 			 -->
...
<script type="text/javascript" src="js/selfJS/task/iconTask/topologyGraph.js"> </script> <!-- 用于图标式任务生成的拓扑图js -->
<script type="text/javascript" src="js/selfJS/task/iconTask/iconTask.js"></script>	<!-- 自定义js文件 -->
<script type="text/javascript" src="js/selfJS/task/iconTask/iconTaskSave.js"> </script> <!-- 用于图标式任务生成的拓扑图js -->
