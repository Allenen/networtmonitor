...
<html>
  <head>
    ...
    <title>链路变化测量任务UI</title>
    
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="keyword1,keyword2,keyword3">
	<meta http-equiv="description" content="链路变化测量任务UI">
	
  </head>
  
  <body>
<div id ="PathChangeDiv" style="padding:10px;text-align: center;margin: 0 auto;">
    <div>
    <form id="PathChangeForm" name ="PathChangeForm" method="post">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <input type="checkbox" name="is_cycle" value="1" checked="checked" onclick="this.value=(this.value==0)?1:0"> 上报间隔   间隔：<input class="easyui-textbox" type="text" name = "task_interval" value="30" style="width:50px;"/>
		...
		<div style="float:left;">
			<ul id="pathChangeTree" class="ztree"></ul>
		</div>
    </form>
    </div>
	...
	<script type="text/javascript" src="js/taskManager/normalTask/normalTask_add/PathChangeTaskAddUI.js"></script>
</div>
