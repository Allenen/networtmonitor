...
<div id ="BlockDiv" style="padding:10px;margin:10px 0;display:none;">
    <!-- 编辑阻断监测任务的菜单栏 -->
    <div style="float: right;margin-top:2px;">
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveTask(3,'#BlockChooseTargetDevices',0);">保存</a>
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="saveTask(3,'#BlockChooseTargetDevices',1);">保存并激活</a>
    </div>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick= "editPolicy()" class="easyui-linkbutton">修改策略</a>
        ...
        <table>
            ...
            <tr>
                ...
                <td rowspan="2">
                    <select multiple="multiple" id ="BlockChooseTargetDevices" name = "chooseTargetDevicesList3" ondblclick="moveOptionDbclickTrigger(this,'rightToLeft')" size=16 style="width:200px"></select>
                </td>
            </tr>
            <tr>
