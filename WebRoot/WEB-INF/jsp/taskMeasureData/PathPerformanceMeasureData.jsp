...
<body>
	<div class="easyui-layout" style="width:100%;height:800px;">
		...
		<div data-options="region:'west',title:'任务列表',split:true" style="width:270px;" id="westLayout">
	        <ul id="PathPerformanceMeasureDataQueryTree" class="easyui-tree" style="margin-top:10px;"></ul>
   		</div>
		...
		<div data-options="region:'center',iconCls:'icon-ok',border:false" id="centerLayout">
      		<div class="easyui-layout" style="width:100%;height:600px;">
        		...
        		<div data-options="region:'center',iconCls:'icon-ok'" id="centerTableLayout">
					...
					<button onclick="showSatisfiedPathPerformanceMeasureData();">选择</button>
					
					<div style="margin-left:10px;margin-right:20px;">
						<table id="PathPerformanceMeasureDataQueryTable"></table>
					</div>
        		</div>
	...
	<script type="text/javascript" src="js/taskMeasureData/PathPerformanceMeasureData/PathPerformanceMeasureData_graph.js"></script>		<!-- 链路性能测量数据图标相关文件 -->
	<script type="text/javascript" src="js/taskMeasureData/PathPerformanceMeasureData/PathPerformanceMeasureData_list.js"></script>		<!-- 链路性能测量数据列表相关文件 -->
	<script type="text/javascript" src="js/taskMeasureData/PathPerformanceMeasureData/PathPerformanceMeasureData.js"></script>		<!-- 链路性能测量数据 -->
</body>
