...
<head>
	<meta charset="UTF-8">
	<title>通用业务性能测量数据-EMAIL业务</title>
...
<body>
	<div class="easyui-layout" style="width:100%;height:1000px;">
		<div data-options="region:'north',border:false" style="height:120px" id="northLayout">
		...
		<div data-options="region:'west',title:'任务列表',split:true" style="width:270px;" id="westLayout">
	        <ul id="EMAILCommonServiceMeasureDataQueryTree" class="easyui-tree" style="margin-top:10px;"></ul>
   		</div>
		...
		<div data-options="region:'center',iconCls:'icon-ok'" id="centerLayout">
        		...
        		<div data-options="region:'center',iconCls:'icon-ok'" id="centerTableLayout">
					...
					<button onclick="showSatisfiedEMAILCommonServiceMeasureData();">选择</button>
	...
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/EMAILServiceMeasureData/EMAILServiceMeasureData_list.js"></script>		<!-- 通用业务性能测量数据EMAIL表格形式展示 -->
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/EMAILServiceMeasureData/EMAILServiceMeasureData_graph.js"></script>		<!-- 通用业务性能测量数据EMAIL图形形式展示 -->
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/EMAILServiceMeasureData/EMAILServiceMeasureData.js"></script>		<!-- 通用业务性能测量数据 -->
</body>
