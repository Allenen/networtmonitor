...
<body>
	<div class="easyui-layout" style="width:100%;height:800px;">
    	...
    	<!-- 通用业务测量数据-DNS查询->左侧任务列表 -->
		<div data-options="region:'west',title:'任务列表',split:true" style="width:270px;" id="westLayout">
	        <ul id="DNSCommonServiceMeasureDataQueryTree" class="easyui-tree" style="margin-top:10px;"></ul>
   		</div>
		...
		<div data-options="region:'center',iconCls:'icon-ok'" id="centerLayout">
      		<div class="easyui-layout" style="width:100%;height:600px;">
        		...
        		<div data-options="region:'center',iconCls:'icon-ok'" id="centerTableLayout">
					...
					<button onclick="showSatisfiedDNSCommonServiceMeasureData();">选择</button>
					<table id="DNSCommonServiceMeasureDataQueryTable"></table>
        		</div>
				...
				<div data-options="region:'center',iconCls:'icon-ok'" id="centerGraphLayout" style="display:none;">     											
				   ...
				   <div style="float: left;width: 49%;border: 2px #CDF4FF solid;">
						...
						<!-- 通用业务测量数据-DNS业务服务响应时间 -->
						<div id="dynamicViewForResponseDelay" style="height:500px;"></div>
						<!-- 通用业务测量数据-DNS业务服务响应时间下方信息 -->
						<div style="text-align: center;">
							<span style="margin-right:40px;font-size:20px;">解析域名:<label id="browseFile_responseDelay">40</label>ms</span>
	...
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/DNSServiceMeasureData/DNSServiceMeasureData_list.js"></script>		<!-- 通用业务性能测量数据DNS表格形式展示 -->
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/DNSServiceMeasureData/DNSServiceMeasureData_graph.js"></script>		<!-- 通用业务性能测量数据DNS图形形式展示 -->
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/DNSServiceMeasureData/DNSServiceMeasureData.js"></script>		<!-- 通用业务性能测量数据 -->
</body>
