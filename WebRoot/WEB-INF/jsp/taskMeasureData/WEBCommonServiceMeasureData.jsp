...
<body>
	<div class="easyui-layout" style="width:100%;height:800px;">
    	...
    	<!-- 通用业务测量数据-web查询->左侧任务列表 -->
		<div data-options="region:'west',title:'任务列表',split:true" style="width:270px;" id="westLayout">
	        <ul id="WEBCommonServiceMeasureDataQueryTree" class="easyui-tree" style="margin-top:10px;"></ul>
   		</div>
		...
		<div data-options="region:'center',iconCls:'icon-ok'" id="centerLayout">
      		<div class="easyui-layout" style="width:100%;height:600px;">
        		...
        		<div data-options="region:'center',iconCls:'icon-ok'" id="centerTableLayout">
					...
					<button onclick="showSatisfiedWEBCommonServiceMeasureData();">选择</button>
					<table id="WEBCommonServiceMeasureDataQueryTable"></table>
        		</div>
				...
				<div data-options="region:'center',iconCls:'icon-ok'" id="centerGraphLayout" style="display:none;">     											
				   ...
				   <div style="float: left;width: 49%;border: 2px #CDF4FF solid;">
						...
						<!-- 通用业务测量数据-web业务服务响应时间 -->
						<div id="dynamicViewForResponseDelay" style="height:500px;"></div>
						<!-- 通用业务测量数据-web业务服务响应时间下方信息 -->
						<div style="text-align: center;">
							<span style="margin-right:40px;font-size:20px;">浏览页面:<label id="browseFile_responseDelay">40</label>ms</span>
							<span style="margin-right:40px;font-size:20px;">页面大小:<label id="pageSize_responseDelay">20</label>ms</span>
					...
					<!-- 页面下载时间 -->
					<div style="float: left;width: 49%;border: 2px #CDF4FF solid;">
						<!-- 通用业务测量数据-web业务页面下载时间 -->
						<div id="dynamicViewForPageDelay" style="height:500px;"></div>
						<!-- 通用业务测量数据-web业务页面下载时间下方信息 -->
						<div style="text-align: center;">
							<span style="margin-right:40px;font-size:20px;">浏览页面:<label id="browseFile_pageDelay">40</label>ms</span>
							<span style="margin-right:40px;font-size:20px;">页面大小:<label id="pageSize_pageDelay">20</label>ms</span>
							<span style="margin-right:40px;font-size:20px;">服务响应时间:平均<label id="avgPageDelay">20</label>ms</span>
							<span style="margin-right:40px;font-size:20px;">最大<label id="maxPageDelay">40</label>ms</span>
							<span style="margin-right:40px;font-size:20px;">最小<label id="minPageDelay">40</label>ms</span><br/>
						</div>
					</div>		
        		</div>
      		</div>
	...
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/WEBServiceMeasureData/WEBServiceMeasureData_list.js"></script>		<!-- 通用业务性能测量数据WEB表格形式展示 -->
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/WEBServiceMeasureData/WEBServiceMeasureData_graph.js"></script>		<!-- 通用业务性能测量数据WEB图形形式展示 -->
	<script type="text/javascript" src="js/taskMeasureData/CommonServiceMeasureData/WEBServiceMeasureData/WEBServiceMeasureData.js"></script>		<!-- 通用业务性能测量数据 -->
</body>
