...
<body>
	<div class="easyui-layout" style="width:100%;height:800px;">
		...
		<div data-options="region:'west',title:'任务列表',split:true" style="width:270px;" id="westLayout">
	        <ul id="SLatencyMeasureDataQueryTree" class="easyui-tree" style="margin-top:10px;"></ul>
   		</div>
		...
		<div data-options="region:'center',iconCls:'icon-ok'" id="centerLayout">
      		<div class="easyui-layout" style="width:100%;height:600px;">
        		...
        		<div data-options="region:'center',iconCls:'icon-ok'" id="centerTableLayout">
					...
					<button onclick="showSatisfiedSLatencyMeasureData();">选择</button>
					
					<div style="margin-left:10px;margin-right:20px;">
						<table id="SLatencyMeasureDataQueryTable"></table>
					</div>
          			...
          			<!-- 时延数据 -->
					   <div style="float: left;width: 49%;border: 2px #CDF4FF solid;"> 
					        ...
					        <div style="text-align: center;">
					        	...
					        	<a id="btn" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-chart_line'">历史数据</a>  
					        </div>
					    </div>
					    <!-- 丢包数据 -->
					    <div style="float: left;width: 49%;border: 2px #CDF4FF solid;">
	...
	<script type="text/javascript" src="js/taskMeasureData/SLatencyMeasureData/SLatencyMeasureData_graph.js"></script>		<!-- 与单向时延测量数据曲线图相关文件 -->
	<script type="text/javascript" src="js/taskMeasureData/SLatencyMeasureData/SLatencyMeasureData_list.js"></script>		<!-- 与单向时延测量数据列表相关文件 -->
	<script type="text/javascript" src="js/taskMeasureData/SLatencyMeasureData/SLatencyMeasureData.js"></script>		<!-- 单向时延测量数据 -->
</body>
