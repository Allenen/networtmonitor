 ...
 */
function showSatisfiedPathPerformanceMeasureData()
{
	//1. 得到选中的任务号
	...
	$.ajax({
		...
		success:function(data)
		{
			...
			console.log("data2");
			$('#PathPerformanceMeasureDataQueryTable').datagrid('loadData',data.pathPerformanceMeasureRecords);//加载链路性能测量数据
			console.log("data3");
		},
		error:function()
		{
...
function getAllSelect()
{
	...
	showSatisfiedPathPerformanceMeasureData();
}
