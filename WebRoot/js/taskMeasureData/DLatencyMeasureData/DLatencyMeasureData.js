/** 与双向时延任务相关的javascript文件 */

var m_taskNum = undefined, m_taskTargetArrayForGraph=[], m_biMeasureRecords = undefined;
/**
 * 文档加载完成后触发
 */
$(function(){
	...
	$('#DLatencyMeasureDataQueryTree').tree({
		...
		onClick: function(node)
		{
			...
			$.ajax({
				...
				{
					setDLatencyValue(data.task);//点击任务后设置相应任务的数值
					$('#DLatencyMeasureDataQueryTable').datagrid('loadData',[]);//加载双向时延测量数据
