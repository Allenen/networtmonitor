...
public class BaseDao<T>
{
	...
	public void save(T entity)
	{
		...
		//this.getHibernateTemplate().getSessionFactory().getCurrentSession().save(entity);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Page pagedQuery(String hql, int pageNum, int pageSize,
			Object... values)
	{
		Assert.hasText(hql);
		Assert.isTrue(pageNum >= 1, "pageNo should start from 1");
		// Count查询
